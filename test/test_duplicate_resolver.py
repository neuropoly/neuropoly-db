...
sub-003	source_003	28	M"""
        ...
        resolve_phenotype_duplicates(test_tsv_path, test_annotations_path, verbose=True)
        ...
        assert (
            "participant_id" in resolved_header
            and "participant_id" in resolved_annotations
        ...
        assert (
            "alt_participant_id" in resolved_header
            and "source_id" not in resolved_header
        ...
        assert (
            "source_id" not in resolved_annotations
        ...
        assert all(
            col in resolved_header for col in ["age", "sex"]
